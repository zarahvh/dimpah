...
# But it seems way more postive than negative?
# In the original assignment it is negative, how does the score get calculated there, not an exact science  
# but I do want to check if nothing went wrong with the calculation
