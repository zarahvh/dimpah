...
That is it for the time being in terms of document transformations. We are now confident that we can start counting words to extract meaning. For this we can use nltk's FreqDist.
